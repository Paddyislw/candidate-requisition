        ...
        <Box maxH="50rem" overflowY="auto" px="24px" pb="24px">
          <DataCard title="Requisition Details">
            <KeyValue
              ...
              value={
                urgencyOptions.find(
                  (item) => item?.value === formData?.urgency
                )?.label
              }
            />
            <KeyValue
          ...
          <DataCard title="Job Detail">
            <KeyValue title="Job Title" value={formData?.jobTitle} />
            <KeyValue title="Job Details" value={formData?.jobDetails} />
            <KeyValue title="Job Location" value={formData?.jobLocation} />
          </DataCard>
            ...
            <KeyValue
              ...
              value={
                interviewDurationOptions.find(
                  (item) => item?.value === formData?.interviewDuration
                )?.label
              }
            />
            <KeyValue
              ...
              value={
                interviewLanguageOptions.find(
                  (item) => item?.value === formData?.interviewLanguage
                )?.label
              }
            />
            <KeyValue
              ...
              value={
                interviewModeOptions.find(
                  (item) => item?.value === formData?.interviewMode
                )?.label
              }
            />
          </DataCard>
